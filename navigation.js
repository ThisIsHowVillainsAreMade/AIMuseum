...
const toggleAbout = () => {
    ...
    if (document.getElementById('toggle-submit').classList.contains('toggle-active')) {
      toggleForm();
    }
    ...
    document.getElementById('blur-background').classList.toggle('blur-background-active');
  ...
  const toggleForm = () => {
    ...
    if (document.getElementById('toggle-about').classList.contains('toggle-active')) {
      toggleAbout();
    }
    // Met mon bouton about en "active"
